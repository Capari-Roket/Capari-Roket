...
void   loop() {
    ...
    float P = bmp.readPressure()/100;    //displaying the Pressure in inches of mercury, you can change the unit
    Serial.print(F("Pressure   = "));
    Serial.print(P);
    Serial.println(" hPa");

    float   A = bmp.readAltitude(1013);   //The "1019.66" is the pressure(hPa)   at sea level in day in your region
